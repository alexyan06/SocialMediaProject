...
public interface SocialMediaInterface {
    ...
    ArrayList<String> addDM(Account sender, Account receiver, ArrayList<String>
            messages, String message) throws InvalidTargetException;

    // Remove a message at specified index if sent by the remover
    ArrayList<String> removeDM(ArrayList<String> messages, Account remover,
                               Account other, int index) throws InvalidTargetException;
